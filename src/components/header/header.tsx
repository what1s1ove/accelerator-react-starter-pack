      ...
      <div className="container header__wrapper"><a className="header__logo logo" href="main.html"> <img className="logo__img" width="70" height="70" src="./img/svg/logo.svg" alt="Логотип" /></a>
        <nav className="main-nav">
          <ul className="main-nav__list">
            ...
            <li><Link className="link main-nav__link" href="#" to={AppRoute.PageNotFound}>Где купить?</Link>
            </li>
            <li><Link className="link main-nav__link" href="#" to={AppRoute.PageNotFound}>О компании</Link>
            </li>
          </ul>
        </nav>
        <HeaderFormSearch />
