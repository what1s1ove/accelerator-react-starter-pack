...
import { getGuitars, getGuitarsLoading } from 'store/catalog-slice/catalog-selectors';
import { loadGuitars } from 'store/catalog-slice/catalog-slice';
  ...
  return (
    <>
      ...
      <ul className="breadcrumbs page-content__breadcrumbs">
        ...
        <li className="breadcrumbs__item"><a className="link" href='/'>Каталог</a></li>
      </ul>
      <div className="catalog">
        ...
        <ProductList guitars={guitars} loading={guitarsLoading}/>
